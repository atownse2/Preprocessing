...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:MAODv2-0000.root'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('NAODv9-0000.root'),
