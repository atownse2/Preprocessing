...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:RECO-0000.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MAODv2-0000.root'),
