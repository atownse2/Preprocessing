...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:wmLHEGEN-0000.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SIM-0000.root'),
